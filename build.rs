fn main() {
    ...
    if target_os == "windows" {
        ...
        res.set("FileDescription", "Wallp - Wallpaper Changer (v1.1)");
        res.set("ProductName", "Wallp - Wallpaper Changer (v1.1)");
        ...
        // winres might need help finding the resource compiler and archiver.
        #[cfg(not(windows))]
        {
        ...
        if let Err(e) = res.compile() {
            ...
            // On non-Windows hosts, the linker often ignores the static library 
            // generated by winres because no symbols are referenced.
            // We force it by passing the object file directly.
            #[cfg(not(windows))]
            {
